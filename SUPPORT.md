...
Email [LiveFaceSwap AI support](mailto:support@livefaceswap.ai) for account access, billing, credit questions, private media, or any case that cannot be safely discussed in public.

## Canonical Discussion

The [canonical LiveFaceSwap AI repository](https://github.com/LiveFaceSwapAI/livefaceswap) is the primary public discussion location. Future platform mirrors may accept platform-specific feedback but will route product-wide decisions back here.
